...
const HomePage = () => {
  ...
  return (
    <div className="homepage" style={{ minHeight: '100vh', padding: '20px', color: '#333' }}>
      ...
      <section className="top-content" style={{ display: 'flex', marginBottom: '20px' }}>
      ...
      <section className="button" style={{ textAlign: 'center', marginTop: '20px' }}>
        <button onClick={handleNavigate} className="navigate-button" style={{ padding: '10px 20px', backgroundColor: '#007acc', color: '#fff', border: 'none', borderRadius: '5px', cursor: 'pointer' }}>
          Go to IPA Chart
        </button>
      </section>
    </div>
